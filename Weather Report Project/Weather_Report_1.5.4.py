...
def main(link):
    ...
    for i in range(10):
        tomorowdate += date[i]
    answer = ""
    answer += "GÜÜD ËVBËNEENG.\n\n"
    #print()
    answer += "The weather for tomorow " + str(tomorowdate) + " for " + str(location[1]) + "\n\n"
    #print()
...
#postalCode = "34711" #ryan
#postalCode = "30159 Germany"
#postalCode = "20740"
...
output = str((main(link)))
print(output)

textfilename = "nameexoprt"
